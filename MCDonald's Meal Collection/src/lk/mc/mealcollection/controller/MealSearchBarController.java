...
import lk.mc.mealcollection.controller.CollectionController;
 ...
 * @author lakitha
 */
public class MealSearchBarController implements Initializable, Observer {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(MealSearchBarController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(MealSearchBarController.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            btnUpdate.addEventHandler(MouseEvent.MOUSE_CLICKED, (eventEstimate) -> {
                try {
                    ...
                    if (CollectionController.editController(itemDTO)) {
