 ...
 * @author lakitha
 */
public class MealCollection implements Initializable, Observer {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Logger.getLogger(MealCollection.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void treeTableActivities() {
        try {
            ...
            List<ItemDTO> allItems = MealSearchController.findAllMeals();
            ...
            mealTreeTable.addEventHandler(MouseEvent.MOUSE_CLICKED, (e) -> {
                ...
                if (selectedItem.equals(null)) {
                    ...
                    try {
                        ...
                        ItemDTO itemDTO = MealSearchController.findMealByName(selectedItem.getValue());
