...
public class CustomerCenterController implements Initializable {
    ...
    @FXML
    private JFXTextField txtCustNameFront;
    @FXML
    private JFXTextField txtMobileNumberFront;
    @FXML
    private JFXTextField txtAddressFront;
    ...
    private void saveCustomer(MouseEvent event) throws Exception {
        ...
        customerDTO.setName(txtCustNameFront.getText());
        customerDTO.setMobileNumber(txtMobileNumberFront.getText());
        customerDTO.setAddress(txtAddressFront.getText());
